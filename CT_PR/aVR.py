...
class AVR(func.PWave):
    def __init__(self, cleaned_signal, sampling_rate=400, anterior_leads=None):
        ...
        # self.cleaned_signal = -1 * cleaned_signal
        self.cleaned_signal = cleaned_signal
        self.anterior_leads = anterior_leads[0]
        self.baseline = 0
        self.win_time = 40  # 40 milliseconds for J40 and J80

        # AN Object For T wave Analysis
        self.t_obj = None
    ...
    def set_r_peaks(self, r_pears, baseline=0, show=True, adjust_sig=True):
        ...
        self.r_peaks["value"] = -1 * self.r_peaks["value"]
    ...
    def calculate_p_peaks(self, show=False, r=False):
        ...
        self.p_peak, self.p_amp, amps = self.find_p_peaks(polarity=0)
    ...
    def get_basic_t(self, show=True, j_point=None):
        ...
        ttw = self.t_obj.get_t_wave(show=False, j_point=j_point)
