...
class LeadIII(func.PWave):
    ...
    def get_basic_t(self, show=True, j_point=None):
        ...
        # TODO: verify j point and t onset point
        ...
        self.j40 = []
        self.j80 = []
        for _jp, _ot in zip([i[0] for i in self.j_point], self.t_onset):
            print(f"JP: {_jp}, {_ot}")
